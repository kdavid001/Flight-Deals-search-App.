...
for destination in sheet_data:
    ...
    if cheapest_flight.price != "N/A" and cheapest_flight.price < destination["lowestPrice"]:
        ...
        """
        This is used to send the result of the flight search to your whatsapp number but this has to be set up using Twilio 
        """
# TODO: work on the notification manager.
        ...
        # to Return the result in your console.
